...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001794443246').split()]
...
URL = "https://https://captain-r73r.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://https://captain-r73r.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://https://captain-r73r.onrender.com/".format(FQDN)
else:
    URL = "https://https://captain-r73r.onrender.com/".format(FQDN)
