...
REQUEST_TO_JOIN_MODE = bool(environ.get('REQUEST_TO_JOIN_MODE', )) # Set True Or False
TRY_AGAIN_BTN = bool(environ.get('TRY_AGAIN_BTN', False)) # Set True Or False
auth_channel = environ.get('-1001977482249', '') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://power56381373:waZlpuypx06akpCc@cluster0.f4mixtb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'prime3602') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+mBGvu968HHdiNjE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+mBGvu968HHdiNjE1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CINEMA_CLUB') # Support Chat Link Without https:// or @
